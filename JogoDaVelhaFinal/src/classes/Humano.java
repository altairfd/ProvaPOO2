...
public class Humano extends Jogador{
    ...
    @Override
    public void jogar(MesaJogo mesaJogo){
        Tentativa(mesaJogo);
        mesaJogo.setPosicao(tentativa, jogador);
    }
    
    @Override
    public void Tentativa(MesaJogo mesaJogo){
        do{
            do{
            ...
            if(!checaTentativa(tentativa, mesaJogo))
                System.out.println("Esse local já foi marcado. Tente outro.");
        }while(!checaTentativa(tentativa, mesaJogo) );
    }
}